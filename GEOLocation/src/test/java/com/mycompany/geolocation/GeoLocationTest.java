...
//        GeoLocatorImpl geoLocator = new GeoLocatorImpl();
    ...
    */
    ...
    public void testConnection()throws IOException
    {
        GeoLocatorImpl geoLocator = new GeoLocatorImpl("http://localhost:8080/","");
//        GeoLocatorImpl geoLocator = new GeoLocatorImpl();
//        GeoLocatorImpl geoLocator = new GeoLocatorImpl("http://ip-api.com/xml/","4.2.2.2");
...
////        System.err.println("##############  "+WireMock.listAllStubMappings().getMappings());
//        Location location = new Location();
////        InputStream ins=geoLocator.getURLConnection("http://freegeoip.net/xml/4.2.2.2").getInputStream();
//        InputStream ins = geoLocator.getURLConnection();
//        location = geoLocator.xmlParsing(ins);
//        GeoLocation.getAddress(location);
